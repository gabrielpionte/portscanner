...
dt = datetime.now()
#A linha 15 serve para determinar o tempo das conexões, nesse caso 0.25 segundos.
socket.setdefaulttimeout(0.25)
#A linha 17 serve para evitar modificações ao mesmo tempo, permitindo apenas que uma thread acesse a variavel por vez
...
for x in range(10000):
    ...
    t.daemon = True
    t.start()
#A linha 40 e 41 servem para definir qual é o range de portas que serão escaneadas.
